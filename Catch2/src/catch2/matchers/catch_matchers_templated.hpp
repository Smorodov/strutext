...
namespace Matchers {
    ...
    namespace Detail {
        ...
        struct MatchAllOfGeneric final : MatcherGenericBase {
            ...
            std::string describe() const override {
                return describe_multi_matcher<MatcherTs...>(" && "_sr, m_matchers, std::index_sequence_for<MatcherTs...>{});
            }
        ...
        struct MatchNotOfGeneric final : MatcherGenericBase {
            ...
            //! Negating negation can just unwrap && return underlying matcher
    ...
    // compose mixed generic && non-generic matchers
