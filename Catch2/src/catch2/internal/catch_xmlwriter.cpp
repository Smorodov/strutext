...
namespace {
    ...
    void XmlEncode::encodeTo( std::ostream& os ) const {
        ...
        for( std::size_t idx = 0; idx < m_str.size(); ++ idx ) {
            ...
            default:
                // Check for control characters && invalid utf-8
                ...
                // UTF-8 territory
                // Check if the encoding is valid && if it is not, hex escape bytes.
                ...
                // This means: bitpattern 10XX XXXX && the extracted value is sane (ish)
                bool valid = true;
