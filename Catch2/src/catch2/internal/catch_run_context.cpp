...
namespace Catch {
    ...
    namespace Generators {
        struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
            ...
            static GeneratorTracker& acquire( TrackerContext& ctx, TestCaseTracking::NameAndLocation const& nameAndLocation ) {
                ...
                // tracker's children, && instead return the current
                // tracker.
            ...
            void close() override {
                ...
                // && none of its children have started, then we must wait
                ...
                const bool should_wait_for_child = [&]() {
                    ...
                    // start, && thus we should wait for them, or they cannot
                    // start (due to filters), && we shouldn't wait for them
    ...
    void RunContext::assertionEnded(AssertionResult const & result) {
        ...
        // && should be let to clear themselves out.
